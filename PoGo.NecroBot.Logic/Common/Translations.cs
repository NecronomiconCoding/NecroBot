...
namespace PoGo.NecroBot.Logic.Common
{
    ...
    public class Translation : ITranslation
    {
            ...
            <KeyValuePair<TranslationString, string>>
        {
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.UseLuckyEggIsFlase,
                "WaitForLuckyEggEvolving requires UseLuckyEggWhileEvolving to be set to true!"),
