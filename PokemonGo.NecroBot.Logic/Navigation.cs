...
namespace PokemonGo.NecroBot.Logic
{
    public class Navigation
    {
        ...
        public Navigation(Logic logic, Client client)
        {
            _logic = logic;
            _client = client;
        }
            ...
            double walkingSpeedInKilometersPerHour, Func<Task> functionExecutedWhileWalking)
        {
            ...
            var result = await _logic.UpdatePlayerLocation(waypoint.Latitude, waypoint.Longitude, _client.Settings.DefaultAltitude);
            ...
            do
            {
                ...
                result = await _logic.UpdatePlayerLocation(waypoint.Latitude, waypoint.Longitude, _client.Settings.DefaultAltitude);
