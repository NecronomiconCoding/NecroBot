...
namespace PokemonGo.NecroBot.CLI
{
        ...
        : Logic.ISettings
    {
        ...
        public bool EnableHighestPokemonInfo => UserSettings.Default.EnableHighestPokemonInfo;

        public double LastPositionLatitude
        {
            get { return UserSettings.Default.LastPositionLatitude; }
            set
            {
                UserSettings.Default.LastPositionLatitude = value;
        ...
        {
            get { return UserSettings.Default.LastPositionLongitude; }
            set
            {
                UserSettings.Default.LastPositionLongitude = value;
                UserSettings.Default.Save();
            }
        }

        public double LastPositionAltitude
        {
            get { return UserSettings.Default.LastPositionAltitude; }
            set
            {
                UserSettings.Default.LastPositionAltitude = value;
                UserSettings.Default.Save();
            }
        }
        ...
        private static ICollection<PokemonId> LoadPokemonList(string filename, string[] defaultContent)
        {
            ...
            {
                ConsoleLogger.WriteConsole($"Loading File: {filename}");
            ...
            {
                ConsoleLogger.WriteConsole($"File: {filename} not found, creating new...", LogLevel.Warning);
