...
namespace PokemonGo.RocketAPI.Logic
{
    public class Logic
    {
        ...
        private async Task UpdateTitleInfo(bool updateOnly = false)
        {
            ...
            {
                var message =
                    $" {playerName} | Level {playerStat.Level:0} - ({playerStat.Experience - playerStat.PrevLevelXp:0} / {playerStat.NextLevelXp - playerStat.PrevLevelXp:0} XP) Position: {playerLat}, {playerLng}";
