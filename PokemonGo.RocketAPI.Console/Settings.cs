...
namespace PokemonGo.RocketAPI.Console
{
    public class Settings : ISettings
    {
        ...
        public ICollection<KeyValuePair<ItemId, int>> ItemRecycleFilter => new[]
        {
            ...
            new KeyValuePair<ItemId, int>(ItemId.ItemPokeBall, 222),
            new KeyValuePair<ItemId, int>(ItemId.ItemGreatBall, 222),
            new KeyValuePair<ItemId, int>(ItemId.ItemUltraBall, 222),
            new KeyValuePair<ItemId, int>(ItemId.ItemMasterBall, 222),
            new KeyValuePair<ItemId, int>(ItemId.ItemPotion, 0),
            new KeyValuePair<ItemId, int>(ItemId.ItemSuperPotion, 0),
            new KeyValuePair<ItemId, int>(ItemId.ItemHyperPotion, 55),
            new KeyValuePair<ItemId, int>(ItemId.ItemMaxPotion, 55),
            new KeyValuePair<ItemId, int>(ItemId.ItemRevive, 55),
            new KeyValuePair<ItemId, int>(ItemId.ItemMaxRevive, 55),
